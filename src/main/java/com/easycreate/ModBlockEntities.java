...
public final class ModBlockEntities {
   ...
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EnderChuteBlockEntity>> ENDER_CHUTE_BLOCK_ENTITY = BLOCK_ENTITY_TYPES.register(
      "ender_chute", () -> Builder.of(EnderChuteBlockEntity::new, new Block[]{(Block)ModBlocks.ENDER_CHUTE.get()}).build(null)
   );

   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<com.easycreate.content.EnderFluidTankBlockEntity>> ENDER_FLUID_TANK = BLOCK_ENTITY_TYPES.register(
   ...
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<com.easycreate.content.EnderSpeedControllerBlockEntity>> ENDER_SPEED_CONTROLLER = BLOCK_ENTITY_TYPES.register(
