...
public class EasyCreatePonderPlugin implements PonderPlugin {
   private static final ResourceLocation ENDER_CHUTE_ID = new ResourceLocation("easycreate", "ender_chute");
   ...
   public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
      ...
      helper.addStoryBoard(
         ENDER_CHUTE_ID,
         new ResourceLocation("easycreate", "ender_chute_basics"),
         EnderChuteScenes::basic,
         new ResourceLocation[]{AllCreatePonderTags.LOGISTICS}
      );
      helper.addStoryBoard(
         ENDER_CHUTE_ID, new ResourceLocation("easycreate", "ender_chute_wireless"), EnderChuteScenes::wireless, new ResourceLocation[0]
      );
   }
   ...
   private static ResourceLocation id(String path) { return new ResourceLocation("easycreate", path); }
}
